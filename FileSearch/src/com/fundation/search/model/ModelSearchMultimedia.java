...
public class ModelSearchMultimedia {
    ...
    public List<Asset> searchMultimedia(CriterialSearchMultimedia criteria) throws IOException {
            ...
            if (fileIterate.isDirectory()) {
                ...
                searchMultimedia(criteria);
                    ...
                    try{
                        ...
                        if (criteria.getExtencionMultimedia() != null &&
                                !fileIterate.getName().toLowerCase().endsWith(criteria.getExtencionMultimedia())) {
                            continue;
                        }
                        if (!criteria.getInputSizeMultimedia().equals("0") &&
                                !duration(criteria.getCountMultimedia(), criteria.getInputSizeMultimedia(),
    ...
    public boolean duration (String countMultimedia, String inputSizeMultimedia, String durationTypeMultimedia) throws IOException {
